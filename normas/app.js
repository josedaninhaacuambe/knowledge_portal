...
app.use("/especialistas", express.static(__dirname + "/uploads"));
app.use("/especialistas", express.static(__dirname + "/public"));
app.use("/books", express.static(__dirname + "/uploads"));
app.use("/books", express.static(__dirname + "/public"));
app.use("/training", express.static(__dirname + "/uploads"));
app.use("/training", express.static(__dirname + "/public"));
