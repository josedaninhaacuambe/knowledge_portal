        ...
        <div className="">
            ...
            <div class="uk-position-relative uk-padding-remove uk-position-cover uk-background-cover" uk-cover>
                <div>
                    ...
                    <div className=" uk-position-center uk-overlay uk-flex uk-flex-center uk-visible@m uk-overlay-default uk-card uk-card-default uk-card-body" style={{ borderRadius: 20, marginLeft: -400 }}>
                        <div className="surface-card p-4 shadow-2 border-round w-full lg:w-12">
                            <div className="text-center uk-margin-remove-vertical uk-padding-remove-vertical uk-margin-remove mb-5">
                                <img className="mb-3 profile-img-login" style={{ height: "100px", width: "100px" }} src="https://lh3.googleusercontent.com/pw/AL9nZEU-Pml7gon5-l4L3qbgD6BuJXv3SvGXDf_KBNDboOPtH3pejk1VKW5eG9zp0hoe_cLAhNz9NR-rLm6FvepSRrcCtC46QcNlp9s1MBtNheagdlJm3V0tfs_fClrBFB1rgrUFVq_AVnbq33kX8vaIElwt=w457-h438-no?authuser=0" alt="logo" />
                    ...
                    <div className=" uk-position-center uk-overlay uk-flex uk-flex-center uk-hidden@m uk-margin-remove-top uk-flex uk-flex-center uk-overlay-default uk-card uk-card-default uk-card-body" style={{ borderRadius: 20, marginLeft: -350, marginTop: "-30px" }}>
                        <div className="surface-card p-4 shadow-2 border-round w-full lg:w-12">
                            <div className="text-center uk-margin-remove-vertical uk-padding-remove-vertical uk-margin-remove mb-5">
