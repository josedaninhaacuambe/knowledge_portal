       ...
       content={
        ...
        <div className="uk-container">
            ...
            <div className="uk-padding-top uk-margin-top-large">
                ...
                <div class="bg-body rounded uk-margin-large-top uk-margin-large" style={{ marginTop: "10% !important", marginBottom: "15% !important", marginLeft: "20% !important",  marginRight: "20% !important" }}>
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal1" uk-toggle="">
                            ...
                            <p class="uk-margin-small-top">
                                <strong class="d-block text-gray-dark" style={{marginBottom: "10px !important"}} >1_LIONDE MAPAI AS BUILT_2016</strong>
                            </p>
                        </a>
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos LIONDE MAPAI AS BUILD 2016. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1e0eLHf8tZwCz-CkElPqoP6b89OYCSeGa" class="uk-text-lowercase">solicite o acesso,</a> justificando para que fins deseja aplicar.</p>
                                            </div>
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal2" uk-toggle="">
                            <span class="uk-label uk-button uk-label-success uk-rounded" style={{minWidth:"32px", margin: "10px", paddingTop: "5px", height:"32px", background:"rgb(250 127 34 / 90%)", color:"#007bff"}}><span class="uk-light" uk-icon="icon: file-pdf"></span></span>
                            <p class="uk-margin-small-top">
                            <strong class="d-block text-gray-dark" style={{ marginTop: "15px !important;" }}>2_linha 110kV Macomia-Auasse_2009</strong>
                            </p>
                        </a>
                                ...
                                <div className="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos da linha 110kV Macomia-Auasse_2009. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1vQyNZvj2cJIttIJM_eUnfmhYkCowdglg" class="uk-text-lowercase">solicite o acesso,</a> justificando para que fins deseja aplicar.</p>
                                            </div>
                                            <div class="uk-card-footer">
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal3" uk-toggle="">
                            ...
                            <p class="uk-margin-small-top">
                            <strong class="d-block text-gray-dark" style={{ marginTop: "15px !important;" }}>3_AS BUILT DOCS CHIBATA - DONDO_2018</strong>
                            </p>
                        </a>
                                ...
                                <div className="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos AS BUILT DOCS CHIBATA - DONDO_2018. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1a89jcQXGQfVgzKgo0Ndz8VMML3opapl1" class="uk-text-lowercase">solicite o acesso,</a> justificando para que fins deseja aplicar.</p>
                                            </div>
                                            <div class="uk-card-footer">
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal4" uk-toggle="">
                            ...
                            <p class="" style={{ marginTop: "15px !important;" }}>
                            <strong class="d-block text-gray-dark" style={{ marginTop: "15px !important;" }}>4_LINDELA & MASSINGA_2019</strong>
                            </p>
                        </a>
                                ...
                                <div className="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos LINDELA & MASSINGA_2019. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1bOF-dDMefQQwBtWUn0DGqmBCderyMoO7" class="uk-text-lowercase">solicite o acesso,</a> justificando para que fins deseja aplicar.</p>
                                            </div>
                                            <div class="uk-card-footer">
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal5" uk-toggle="">
                            <span class="uk-label uk-button uk-label-success uk-rounded" style={{minWidth:"32px", margin: "10px", paddingTop: "5px", height:"32px", background:"rgb(250 127 34 / 90%)", color:"#6f42c1"}}><span class="uk-light" uk-icon="icon: file-pdf"></span></span>
                            <p class="uk-margin-small-top">
                            <strong class="d-block text-gray-dark" style={{ marginTop: "15px !important;" }}>5_As Built Massinga</strong>
                            </p>
                        </a>
                                ...
                                <div className="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos As Built Massinga. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1nn_fVCOh8IpZANUZTN7HGamw_v9kp9Jl" class="uk-text-lowercase">solicite o acesso,</a> justificando para que fins deseja aplicar.</p>
                                            </div>
                                            <div class="uk-card-footer">
                    ...
                    <div class="d-flex text-muted pt-3">
                        <a class="d-flex uk-link-reset" href="#modal6" uk-toggle="">
                            <span class="uk-label uk-button uk-label-success uk-rounded" style={{minWidth:"32px", margin: "10px", paddingTop: "5px", height:"32px", background:"rgb(250 127 34 / 90%)", color:"#6f42c1"}}><span class="uk-light" uk-icon="icon: file-pdf"></span></span>
                            <p class="uk-margin-small-top">
                            <strong class="d-block text-gray-dark" style={{ marginTop: "15px !important;" }}>6_Zimpeto</strong>
                            </p>
                        </a>
                                ...
                                <div className="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                                    ...
                                    <div class="uk-modal-body">
                                        <div class="uk-card uk-card-default">
                                            ...
                                            <div class="uk-card-body">
                                                <p>O acervo selecionado contem os arquivos da Subestação de Zimpeto. Para aceder os ficheiros, <a href="https://drive.google.com/drive/folders/1AAjTz0QCOat554VFdH81L2fRmnV05RZY" class="uk-text-lowercase">solicite o acesso,</a>  justificando para que fins deseja aplicar.</p>
                                            </div>
                                            <div class="uk-card-footer">
