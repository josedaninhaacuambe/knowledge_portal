              ...
              <div className="uk-navbar-right">
                ...
                <ul class="uk-navbar-nav">
                    ...
                    <li className="uk-active">
                      {/* <a href="/documents">Documentos <span uk-navbar-parent-icon></span></a> */}
                ...
                <div className="uk-grid-match uk-child-width-1-1@m" uk-grid="">
                    <div>
                        <p className="uk-text-center">
                            Acompanhe aqui os principais eventos tais como feiras, conferencias, inaugurações e webinar etc. esteja a par dessa informação.
                        </p>
                    </div>
                </div>
            </div>
